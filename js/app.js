...
Game.trump = function() {
  ...
  for (var i = 0; i < Game.sequenceT.length; i++) {
    squares[Game.sequenceT[i]].className = 'trump';
    Game.pointsT();
  }
};

Game.pointsT = function() {
  this.addEventListener('click', earnPointsT());
  earnPointsT = function () {
